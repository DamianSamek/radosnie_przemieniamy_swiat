...
open class BasePostsAdapter(private val postInteractionContract: PostInteractionContract) :
    ...
    class PostViewHolder(view: View) : BasePaginationViewHolder(view) {
    ...
    interface PostInteractionContract :
        PaginationContract<UserPost> {
